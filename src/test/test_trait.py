...
def test_agregar_promociones():
    ...
    assert df.iloc[1]['FIN DE PERIODO'] == pd.Timestamp('2024-02-14 00:00:00')
...
def test_cambio_fin_de_periodo():
    ...
    df = trait.cambio_fin_de_periodo(df_1, df_2)

    assert df.iloc[1]['FIN DE PERIODO'] == pd.Timestamp('2024-06-30 00:00:00')
